...
public class FavoriteService {
    ...
    public ResponseEntity<Object> insertFavorite (FavoriteDto dto, HttpServletRequest request) {
...
//        }
        ...
        if(!favoriteRepository.existsByUserEntity_idxAndGoodseulEntity_idx(idx, dto.getG_idx())) {
    ...
    public ResponseEntity<Object> deleteFavorite (HttpServletRequest request, @PathVariable Long g_idx) {
        ...
        if(favorite.isPresent()) {
            ...
            return new ResponseEntity<>("찜하기 정보를 찾을 ", HttpStatus.BAD_REQUEST);
        }
